...
// Navigation items
const navItems = [
   { name: "Gösterge Paneli", href: "/admin-dashboard", icon: Home },
   { name: "Kullanıcılar", href: "/admin-dashboard/users", icon: Users },
   { name: "Mekanlar", href: "/admin-dashboard/venues", icon: Music },
   { name: "İzinler", href: "/admin-dashboard/permissions", icon: Shield, requiredRole: "ROLE_OWNER" },
   { name: "Roller", href: "/admin-dashboard/roles", icon: Settings, requiredRole: "ROLE_OWNER" },
   { name: "Şehirler", href: "/admin-dashboard/cities", icon: Building2 },
   { name: "İlçeler", href: "/admin-dashboard/districts", icon: Landmark },
   { name: "Mahalleler", href: "/admin-dashboard/neighborhoods", icon: MapPin },
...
export default function AdminLayout({ children }: { children: ReactNode }) {
   ...
   const { logout: contextLogout, roles } = useAuth();
            ...
            <div className="flex min-h-screen bg-background">
               ...
               >
                  ...
                  <nav className="flex-1 overflow-y-auto p-3 space-y-1">
                     {navItems
                        .filter((item) => {
                           // Eğer öğe için özel bir rol gerekliyse ve kullanıcı bu role sahip değilse gizle
